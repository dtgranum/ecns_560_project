...
knitr::include_graphics("output/attendancehistogram.png")
```
```{r echo=FALSE, out.width = "50%", fig.align = "center"}
knitr::include_graphics("output/donationshistogram.png")
```
...
```
```{r echo=FALSE, out.width = "50%", fig.align = "center"}
knitr::include_graphics("output/year_meanincome.png")
```
```{r echo=FALSE, out.width = "50%", fig.align = "center"}
knitr::include_graphics("output/year_meanattendance.png")
```



```{r echo=FALSE, out.width = "50%", fig.align = "center"}
knitr::include_graphics("output/incomeattendance.png")
```
```{r echo=FALSE, out.width = "50%", fig.align = "center"}
knitr::include_graphics("output/incomedonations.png")
```
