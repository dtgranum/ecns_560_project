...
tidy_PSID <- renamed_PSID |>
  pivot_longer(cols=c("2005_release_num", "2007_release_num", "2009_release_num", "2011_release_num", "2013_release_num", "2015_release_num", "2017_release_num", "2019_release_num", "2021_release_num"), names_to="year4", values_to="release_num") |>
  pivot_longer(cols=c("2005_interview_id", "2007_interview_id", "2009_interview_id", "2011_interview_id", "2013_interview_id", "2015_interview_id", "2017_interview_id", "2019_interview_id", "2021_interview_id"), names_to="year5", values_to="interview_id") |>
  pivot_longer(cols=c("2005_current_state", "2007_current_state", "2009_current_state", "2011_current_state", "2013_current_state", "2015_current_state", "2017_current_state", "2019_current_state", "2021_current_state"), names_to="year6", values_to="current_state") 
...
tidy_PSID <- tidy_PSID |>
  ...
  pivot_longer(cols=c("2005_attendance", "2007_attendance", "2009_attendance", "2011_attendance", "2013_attendance", "2015_attendance", "2017_attendance", "2019_attendance", "2021_attendance"), names_to="year9", values_to="attendance")
